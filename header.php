	...
	<header class="header">
		<div class="container">
			<div class="logo">
				...
				<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/logo_mb_big.jpg" />
				</a>
			</div>
			...
			<div class="cs_logos">
				...
				<a href="<?php echo network_site_url( '/village' ); ?>" class="logo_vl_small othersmall"></a>
